...
class AppColors {
  static var primaryColor = Color.fromRGBO(0, 0, 106, 1);
  static var secondaryColor = Color.fromRGBO(32, 132, 92, 1);
  ...
  static var appTextColorPrimary = Color.fromRGBO(255, 255, 0, 1);
